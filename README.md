[![License](https://img.shields.io/github/license/SumuduLansakara/custom-bash-completion-script)](https://github.com/SumuduLansakara/custom-bash-completion-script/blob/master/LICENSE)
...
[![Stars](https://img.shields.io/github/stars/SumuduLansakara/custom-bash-completion-script?style=social)](https://github.com/SumuduLansakara/custom-bash-completion-script/stargazers)
[![Watchers](https://img.shields.io/github/watchers/SumuduLansakara/custom-bash-completion-script?style=social)](https://github.com/SumuduLansakara/custom-bash-completion-script/watchers)
...
However implementing an auto-completion script can be quite tedious when the required argument scheme gets complex.
Also there is no trivial way for implementing an autocompletion script without utilizing different tools with complicated syntaxes.
